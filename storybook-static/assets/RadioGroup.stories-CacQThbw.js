import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{R as a,a as t}from"./RadioGroup-B1U0Jhbw.js";import"./index-0yr9KlQE.js";import"./index-cqJIykFo.js";import"./index-C8N0VHNy.js";import"./index-DzS6v96A.js";import"./index-C99ZZYO_.js";import"./index-tymuTqDW.js";import"./index-DotmK1FS.js";import"./index-BP_afSKs.js";import"./index-Dd6ISl9I.js";import"./index-HTFOMs3O.js";import"./index-HsyR4iiU.js";import"./index-0rmrMql7.js";import"./index-DJkRsNY1.js";import"./utils-CBfrqCZ4.js";import"./createLucideIcon-CIIyP9qp.js";const G={title:"Elements/RadioGroup",component:a,parameters:{layout:"centered"},tags:["autodocs"]},s={render:()=>e.jsxs(a,{defaultValue:"option-one",children:[e.jsxs("div",{className:"flex items-start space-x-2",children:[e.jsx(t,{value:"option-one",id:"option-one"}),e.jsx("label",{htmlFor:"option-one",className:"text-sm font-medium",children:"Option One"})]}),e.jsxs("div",{className:"flex items-start space-x-2",children:[e.jsx(t,{value:"option-two",id:"option-two"}),e.jsx("label",{htmlFor:"option-two",className:"text-sm font-medium",children:"Option Two with a longer label to test text wrapping behavior in the radio group component"})]})]})},o={render:()=>e.jsxs(a,{defaultValue:"default",children:[e.jsxs("div",{className:"flex items-start space-x-2",children:[e.jsx(t,{value:"default",id:"r1"}),e.jsxs("div",{className:"grid gap-1.5 leading-none",children:[e.jsx("label",{htmlFor:"r1",className:"text-sm leading-none font-medium peer-disabled:cursor-not-allowed peer-disabled:text-text-disabled",children:"Default"}),e.jsx("p",{className:"text-muted-foreground text-sm",children:"Use the system default theme."})]})]}),e.jsxs("div",{className:"flex items-start space-x-2",children:[e.jsx(t,{value:"light",id:"r2"}),e.jsxs("div",{className:"grid gap-1.5 leading-none",children:[e.jsx("label",{htmlFor:"r2",className:"text-sm leading-none font-medium peer-disabled:cursor-not-allowed peer-disabled:text-text-disabled",children:"Light"}),e.jsx("p",{className:"text-muted-foreground text-sm",children:"Use the light theme."})]})]}),e.jsxs("div",{className:"flex items-start space-x-2",children:[e.jsx(t,{value:"dark",id:"r3"}),e.jsxs("div",{className:"grid gap-1.5 leading-none",children:[e.jsx("label",{htmlFor:"r3",className:"text-sm leading-none font-medium peer-disabled:cursor-not-allowed peer-disabled:text-text-disabled",children:"Dark"}),e.jsx("p",{className:"text-muted-foreground text-sm",children:"Use the dark theme."})]})]})]})},l={render:()=>e.jsxs(a,{defaultValue:"option-one",disabled:!0,children:[e.jsxs("div",{className:"flex items-start space-x-2",children:[e.jsx(t,{value:"option-one",id:"disabled-option-one"}),e.jsx("label",{htmlFor:"disabled-option-one",className:"text-sm font-medium peer-disabled:cursor-not-allowed peer-disabled:text-text-disabled",children:"Option One (Selected & Disabled)"})]}),e.jsxs("div",{className:"flex items-start space-x-2",children:[e.jsx(t,{value:"option-two",id:"disabled-option-two"}),e.jsx("label",{htmlFor:"disabled-option-two",className:"text-sm font-medium peer-disabled:cursor-not-allowed peer-disabled:text-text-disabled",children:"Option Two (Disabled)"})]})]})},i={render:()=>e.jsxs(a,{defaultValue:"option-one",className:"flex flex-row space-x-4",children:[e.jsxs("div",{className:"flex items-start space-x-2",children:[e.jsx(t,{value:"option-one",id:"horizontal-one"}),e.jsx("label",{htmlFor:"horizontal-one",className:"text-sm font-medium",children:"Yes"})]}),e.jsxs("div",{className:"flex items-start space-x-2",children:[e.jsx(t,{value:"option-two",id:"horizontal-two"}),e.jsx("label",{htmlFor:"horizontal-two",className:"text-sm font-medium",children:"No"})]}),e.jsxs("div",{className:"flex items-start space-x-2",children:[e.jsx(t,{value:"option-three",id:"horizontal-three"}),e.jsx("label",{htmlFor:"horizontal-three",className:"text-sm font-medium",children:"Maybe"})]})]})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
