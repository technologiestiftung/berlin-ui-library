...
({ className, variant, inverted, size, active, onToggle, children, ...props }, ref) => {
    ...
    return (_jsxs("div", { ref: ref, className: cn(pillVariants({ variant, inverted, size, className }), active && "data-[state=active]", isToggleable && "cursor-pointer"), "data-state": active ? "active" : "inactive", onClick: handleClick, ...props, children: [variant === "info" && (_jsx(InfoIcon, { className: cn(inverted ? "fill-white" : "fill-blue", size === "big" ? "size-4" : "size-3") })), variant === "message" && (_jsx(InfoIcon, { className: cn(inverted ? "fill-white" : "fill-text-base", size === "big" ? "size-4" : "size-3") })), variant === "error" && (_jsx(ErrorIcon, { className: cn(inverted ? "fill-white" : "fill-text-error", size === "big" ? "size-4" : "size-3") })), variant === "success" && (_jsx(SuccessIcon, { className: cn(inverted ? "fill-white" : "fill-text-success", size === "big" ? "size-4" : "size-3") })), children, variant === "filter" && active && (_jsx(TimesIcon, { className: cn("fill-white", size === "big" ? "size-4" : "size-3") }))] }));
});
