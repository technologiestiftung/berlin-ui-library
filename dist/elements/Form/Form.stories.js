...
export const WithError = {
    render: () => {
        ...
        return (_jsx(Form, { ...methods, children: _jsxs("form", { onSubmit: methods.handleSubmit(() => { }), className: "space-y-4", children: [_jsx(FormField, { name: "name", rules: { required: true }, control: methods.control, render: ({ field, fieldState }) => (_jsxs(FormItem, { children: [_jsx(FormLabel, { children: "Name" }), _jsx(FormControl, { children: _jsx(Input, { ...field, placeholder: "Your name", invalid: !!fieldState.error }) }), _jsx(FormDescription, { children: "Enter your full name." }), _jsx(FormMessage, {})] })) }), _jsx(Button, { type: "submit", children: "Submit" })] }) }));
    },
};
