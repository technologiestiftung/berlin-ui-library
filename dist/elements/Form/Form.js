...
const FormLabel = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return (_jsxs(Label, { ref: ref, className: cn(error && "text-destructive font-bold", className), htmlFor: formItemId, ...props, children: [children, required && (_jsx("span", { className: "text-destructive ml-1 text-[1.75em]", children: "*" }))] }));
});
