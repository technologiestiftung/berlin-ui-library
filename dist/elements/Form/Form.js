...
const FormLabel = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return (_jsxs(Label, { ref: ref, className: cn(className), htmlFor: formItemId, ...props, children: [children, required && (_jsx("span", { className: "ml-1 text-[1.75em] text-decorative-destructive", children: "*" }))] }));
});
FormLabel.displayName = "FormLabel";
const FormControl = React.forwardRef(({ className, ...props }, ref) => {
    const { error, formItemId, formDescriptionId, formMessageId } = useFormField();
    return (_jsx(Slot, { ref: ref, id: formItemId, className: cn("p-2", className), "aria-describedby": !error
            ? `${formDescriptionId}`
...
const FormMessage = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return (_jsx("p", { ref: ref, id: formMessageId, className: cn("mb-6 block w-fit min-w-full border border-red-50 bg-red-50 p-[18px] text-red-800", className), ...props, children: body }));
});
