...
function FormFieldWrapper({ formProperty, form, }) {
    ...
    return (_jsx(FormField, { control: form.control, name: id, render: ({ field }) => (_jsxs(FormItem, { children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs(FormLabel, { className: "font-bold", children: [name, isRequired && (_jsx("span", { className: "ml-1 align-top text-[1.75em] leading-none text-decorative-destructive", children: "*" }))] }), helperText && renderTooltip(helperText)] }), _jsx(FormControl, { children: renderField(formProperty, field) }), _jsx(FormDescription, { className: "text-sm text-text-lightest", children: description }), _jsx(FormMessage, {})] })) }, id));
}
