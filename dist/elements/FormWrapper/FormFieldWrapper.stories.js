...
export const RadioGroupInput = {
    render: () => {
        ...
        return (_jsx(Form, { ...methods, children: _jsxs("form", { children: [_jsx(FormFieldWrapper, { formProperty: property, form: methods }), _jsxs("div", { className: "mt-4 p-3 bg-gray-50 rounded-md", children: [_jsxs("p", { className: "text-sm text-gray-600", children: [_jsx("strong", { children: "Selected Value:" }), " ", watchedValue] }), _jsx("p", { className: "text-xs text-gray-500 mt-1", children: "This updates in real-time when you select an option" })] })] }) }));
    },
};
export const RadioGroupInputHorizontal = {
    render: () => {
        ...
        return (_jsx(Form, { ...methods, children: _jsxs("form", { children: [_jsx(FormFieldWrapper, { formProperty: property, form: methods }), _jsxs("div", { className: "mt-4 p-3 bg-blue-50 rounded-md", children: [_jsxs("p", { className: "text-sm text-blue-800", children: [_jsx("strong", { children: "Selected Plan:" }), " ", watchedValue || "None selected"] }), _jsx("p", { className: "text-xs text-blue-600 mt-1", children: "Watch the value change as you select different options" })] })] }) }));
    },
};
