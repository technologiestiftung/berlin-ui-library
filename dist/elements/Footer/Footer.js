...
function FooterContent({ footerColumns = [], berlinFooter, LinkComponent = ({ href, children, ...props }) => (_jsx("a", { href: href, ...props, children: children })), className = "", showScrollToTop = true, }) {
    ...
    const ScrollToTopButton = () => (_jsxs("button", { className: "flex w-48 cursor-pointer gap-x-2 p-2", onClick: () => window.scrollTo({ top: 0, behavior: "smooth" }), children: [translate("toTheTop"), " ", _jsx(ArrowUpIcon, { className: "bg-red" })] }));
