...
const DrawerContent = React.forwardRef(({ side = "right", size = "default", className, children, ...props }, ref) => {
    return (_jsxs(DrawerPortal, { children: [_jsx(DrawerOverlay, {}), _jsxs(DrawerPrimitive.Content, { ref: ref, className: cn(drawerVariants({ side, size }), "overflow-y-auto", className), ...props, children: [children, _jsxs(DrawerPrimitive.Close, { className: "ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-1 right-4 cursor-pointer rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:pointer-events-none", children: [_jsx(CloseIcon, { className: "m-2 text-black" }), _jsx("span", { className: "sr-only", children: "Close" })] })] })] }));
});
