...
const BreadcrumbList = React.forwardRef(({ className, ...props }, ref) => (_jsx("ol", { ref: ref, className: cn("text-muted-foreground flex flex-wrap items-center gap-[0.3em] text-sm break-words md:gap-[0.3em]", className), ...props })));
