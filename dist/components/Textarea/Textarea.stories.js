...
export const WithLabel = {
    render: () => (_jsxs("div", { className: "grid w-[300px] gap-1.5", children: [_jsx("label", { htmlFor: "message", className: "text-sm font-medium", children: "Your message" }), _jsx(Textarea, { id: "message", placeholder: "Type your message here" }), _jsx("p", { className: "text-sm text-muted-foreground", children: "Your message will be sent to our team." })] })),
};
export const Large = {
