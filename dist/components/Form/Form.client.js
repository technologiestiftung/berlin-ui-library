...
const FormLabel = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return (_jsxs(Label, { ref: ref, className: cn(error && "text-destructive font-bold", className), htmlFor: formItemId, ...props, children: [children, required && _jsx("span", { className: "text-destructive ml-1", children: "*" })] }));
});
...
const FormDescription = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (_jsx("p", { ref: ref, id: formDescriptionId, className: cn("text-sm text-text-lightest", className), ...props }));
});
