      ...
      children: [
        /* @__PURE__ */ e.jsxs(
          "button",
          {
            ...
            "aria-expanded": t,
            children: [
              /* @__PURE__ */ e.jsx("span", { className: "bg-berlin-pink flex size-6 items-center justify-center text-[11px] font-bold", children: r.toLowerCase() }),
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ e.jsx("ul", { children: i.map((l) => /* @__PURE__ */ e.jsx("li", { children: /* @__PURE__ */ e.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ e.jsx("span", { className: "bg-berlin-pink flex size-6 items-center justify-center text-[11px] font-bold", children: l.code.toLowerCase() }),
                  l.label
                ]
              }
            ) }, l.code)) })
