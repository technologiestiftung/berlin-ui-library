...
import { cn as u } from "./index29.es.js";
import m from "./index38.es.js";
import i from "./index39.es.js";
import y from "./index40.es.js";
import w from "./index30.es.js";
import j from "./index41.es.js";
import b from "./index37.es.js";
import k from "./index42.es.js";
import v from "./index43.es.js";
import N from "./index44.es.js";
import { Spinner as z } from "./index26.es.js";
const S = (r, t, l) => {
  ...
  return /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    ...
    /* @__PURE__ */ e.jsx("span", { className: "pointer-events-none absolute top-0 right-0 flex h-full w-[39px] items-center justify-center", children: r === "default" || r === "colored" || r === "fulltone" || r === "light-fulltone" ? /* @__PURE__ */ e.jsx(e.Fragment, { children: l ? /* @__PURE__ */ e.jsx(z, { size: "extraSmall", innerOnly: !0 }) : /* @__PURE__ */ e.jsx(m, { className: "size-5 text-white" }) }) : r === "search" ? /* @__PURE__ */ e.jsx(y, { className: "size-[18px] text-white" }) : r === "filter" ? /* @__PURE__ */ e.jsx(j, { className: "size-4 text-white" }) : r === "extern" ? /* @__PURE__ */ e.jsx(b, { className: "size-4 text-white" }) : r === "download" ? /* @__PURE__ */ e.jsx(k, { className: "size-[18px] text-white" }) : r === "addtocart" ? /* @__PURE__ */ e.jsx(N, { className: "size-[18px] text-white" }) : r === "play" ? /* @__PURE__ */ e.jsx(v, { className: "size-[18px] text-white" }) : null })
  ] });
}, $ = h(
  // base styles for all buttons
  "relative inline-block min-h-[43px] w-auto cursor-pointer justify-center overflow-visible rounded-none border-2 border-black bg-white px-4 py-[10px] text-center text-base leading-[1.2] text-black no-underline transition-colors duration-200 ease-out disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
...
function H({
  ...
  const c = a ? f : "button", p = o && d ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    /* @__PURE__ */ e.jsx("span", { className: "price mr-[0.7em] border-r border-black/60 pr-[0.7em]", children: d }),
...
//# sourceMappingURL=index10.es.js.map
