...
function v({
  ...
  return /* @__PURE__ */ e.jsxs("footer", { className: `w-full bg-block-colored ${d}`, children: [
    /* @__PURE__ */ e.jsx("div", { className: "flex w-full items-start justify-between lg:p-6", children: /* @__PURE__ */ e.jsxs("div", { className: "flex w-full flex-wrap justify-between lg:items-start lg:pl-[5%]", children: [
      ...
      /* @__PURE__ */ e.jsx("div", { className: "flex w-full flex-col lg:hidden lg:w-auto lg:flex-row lg:flex-wrap", children: /* @__PURE__ */ e.jsx(h, { collapsible: !0, type: "single", variant: "footer", children: a.map((l, s) => /* @__PURE__ */ e.jsxs(j, { value: l.title, children: [
      ...
      /* @__PURE__ */ e.jsx("div", { className: "flex w-full flex-col lg:w-auto lg:flex-row lg:flex-wrap", children: a.map((l) => /* @__PURE__ */ e.jsxs(
        "div",
        {
