...
const FilterButton: React.FC<FilterButtonProps> = ({ onClick, numActiveFilters }) => {
  const Comp: "button" | React.ForwardRefExoticComponent<SlotProps & React.RefAttributes<HTMLElement>> = "button"
